...
import { CheckCircle, TreePine, Leaf, Axe, Clock, Award, ShieldCheck } from "lucide-react"
  ...
  return (
    <>
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="container text-center text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Professional Tree Services</h1>
            <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-8">
              Expert tree care solutions for residential and commercial properties
            </p>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              ...
              <CardContent>
                <CardDescription className="text-base">
                  Professional pruning to improve tree health, appearance, and safety.
                </CardDescription>
                <Link
                  href="/services#tree-trimming"
                  className="text-green-700 font-medium inline-block mt-4 hover:underline"
                >
                  Learn more
                </Link>
              </CardContent>
            ...
            <Card className="border-green-100 hover:border-green-300 transition-colors">
              <CardHeader className="pb-2">
                <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center mb-4">
                  <Axe className="h-6 w-6 text-green-700" />
                </div>
                <CardTitle>Tree Removal</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-base">
                  Safe and efficient removal of dead, diseased, or unwanted trees.
                </CardDescription>
                <Link
      ...
      <section className="py-16 md:py-24 bg-green-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Copper Top</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We're committed to providing the highest quality tree care services with safety and customer satisfaction
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Our certified arborists have over 15 years of experience in the tree care industry.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Quick response times for both regular service and emergency situations.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Environmentally responsible practices and proper disposal of all tree waste.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  From consultation to cleanup, we handle every aspect of your tree care needs.
                </p>
              </div>
            </div>
          </div>
